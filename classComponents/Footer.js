...
class Footer extends Component {
    ...
    showContact(e) {
        const contactDiv = document.querySelector('.footer--contact-details');
    ...
    render() {
        return(
            <footer className="center-column">
                <div className="footer-wrapper center-column">
                    <div className="footer--toggle-btn unrotated">
                        <svg onClick={this.showContact} xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                    ...
                    <div className="center-column footer--contact-details hidden">
